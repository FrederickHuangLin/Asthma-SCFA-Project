...
plot_clme = function(clme_obj, group, y_min, y_max, p_gap, ...) {
...
fit6 = clme(Valeric ~ wheezing + BMI + age + income + sex_fetus1 + education +
              (1 | Study_ID), 
            data = df_merge, constraints = cons, seed = 123)
fit7 = clme(Hexanoic ~ wheezing + BMI + age + income + sex_fetus1 + education +
              (1 | Study_ID), 
            data = df_merge, constraints = cons, seed = 123)
...
fig5 = plot_clme(summ_fit5, group = c("No", "Yes"),
  ...
  labs(x = NULL, y = "Concentration", title = "Isovaleric Acid")
fig6 = plot_clme(summ_fit6, group = c("No", "Yes"), 
                 y_min = -1, y_max = 1.2, p_gap = 1.1) +
  labs(x = NULL, y = "Concentration", title = "Valeric Acid")
fig7 = plot_clme(summ_fit7, group = c("No", "Yes"), 
                 y_min = 0, y_max = 0.08, p_gap = 0.02) +
  labs(x = NULL, y = "Concentration", title = "Hexanoic Acid")

p_clme2 = ggarrange(fig1, fig2, fig3, fig4, fig5, fig6, fig7,
                    ncol = 7, common.legend = TRUE, legend = "bottom")
p_clme2
ggsave("../figures/clme_plot2.jpeg", width = 14, height = 5, dpi = 100)
ggsave("../figures/clme_plot2.pdf", width = 14, height = 5)
```

# 4. Correlations {.tabset}
...
```{r, fig.width=10}
scfa_list = c("Acetic", "Propionic", "Isobutyric", "Butyric", 
              "Isovaleric", "Valeric", "Hexanoic")
df_scfa = df_v1 %>%
...
p_heat_v1
ggsave("../figures/heatmap_v1.jpeg", width = 10, height = 5, dpi = 100)
ggsave("../figures/heatmap_v1.pdf", width = 10, height = 5)
```
...
p_heat_v2
ggsave("../figures/heatmap_v2.jpeg", width = 10, height = 5, dpi = 100)
ggsave("../figures/heatmap_v2.pdf", width = 10, height = 5)
```

...
p_total
ggsave("../figures/covariate_adjust/violine_total_v1.jpeg", width = 6.25, height = 5, dpi = 100)
ggsave("../figures/covariate_adjust/violine_total_v1.pdf", width = 6.25, height = 5)
```
...
p_total = ggviolin(df_v2, x = "wheezing", y = "total", color = "wheezing",
  ...
  scale_color_npg(name = NULL)
p_total
ggsave("../figures/covariate_adjust/violine_total_v2.jpeg", width = 6.25, height = 5, dpi = 100)
ggsave("../figures/covariate_adjust/violine_total_v2.pdf", width = 6.25, height = 5)
```
...
p_box
ggsave("../figures/covariate_adjust/box_plot_time_change.jpeg", width = 10, height = 6, dpi = 100)
ggsave("../figures/covariate_adjust/box_plot_time_change.pdf", width = 10, height = 6)
```
...
p_box_alpha
ggsave("../figures/covariate_adjust/box_plot_alpha.jpeg", width = 6.25, height = 5, dpi = 100)
ggsave("../figures/covariate_adjust/box_plot_alpha.pdf", width = 6.25, height = 5)
```
...
p_box = ggarrange(bxp_list_v1[[1]], bxp_list_v1[[2]], bxp_list_v1[[3]], 
                  ...
                  common.legend = TRUE, legend = "bottom")
p_box
ggsave("../figures/covariate_adjust/box_plot.jpeg", width = 12, height = 10, dpi = 100)
ggsave("../figures/covariate_adjust/box_plot.pdf", width = 12, height = 10)
```
...
p_clme1
ggsave("../figures/covariate_adjust/clme_plot_v1_increase.jpeg", width = 12, height = 5, dpi = 100)
ggsave("../figures/covariate_adjust/clme_plot_v1_increase.pdf", width = 12, height = 5)
```
...
p_clme2 = ggarrange(fig1, fig2, fig3, fig4, fig5, fig6, 
                    ncol = 6, common.legend = TRUE, legend = "bottom")
p_clme2
ggsave("../figures/covariate_adjust/clme_plot_v1_decrease.jpeg", width = 12, height = 5, dpi = 100)
ggsave("../figures/covariate_adjust/clme_plot_v1_decrease.pdf", width = 12, height = 5)
```
...
p_clme1 = ggarrange(fig1, fig2, fig3, fig4, fig5, fig6, 
                    ncol = 6, common.legend = TRUE, legend = "bottom")
p_clme1
ggsave("../figures/covariate_adjust/clme_plot_v2_increase.jpeg", width = 12, height = 5, dpi = 100)
ggsave("../figures/covariate_adjust/clme_plot_v2_increase.pdf", width = 12, height = 5)
```
...
p_clme2 = ggarrange(fig1, fig2, fig3, fig4, fig5, fig6, 
                    ncol = 6, common.legend = TRUE, legend = "bottom")
p_clme2
ggsave("../figures/covariate_adjust/clme_plot_v2_decrease.jpeg", width = 12, height = 5, dpi = 100)
ggsave("../figures/covariate_adjust/clme_plot_v2_decrease.pdf", width = 12, height = 5)
```
...
p_heat_v1
ggsave("../figures/covariate_adjust/heatmap_v1.jpeg", width = 10, height = 5, dpi = 100)
ggsave("../figures/covariate_adjust/heatmap_v1.pdf", width = 10, height = 5)
```
...
p_heat_v2
ggsave("../figures/covariate_adjust/heatmap_v2.jpeg", width = 10, height = 5, dpi = 100)
ggsave("../figures/covariate_adjust/heatmap_v2.pdf", width = 10, height = 5)
```

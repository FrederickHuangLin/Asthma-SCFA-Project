...
df_corr1 = as.data.frame(corr1) %>%
  rownames_to_column("var1") %>%
  pivot_longer(cols = -var1, names_to = "var2", values_to = "value")
df_fig1 = df_corr1 %>%
  left_join(df_p_v1, by = c("var1", "var2")) %>%
  mutate(text_color = ifelse(pvalue < 0.05, "1", "0"))

p_heat1 = df_fig1 %>%
  ggplot(aes(x = var1, y = var2, fill = value)) +
  geom_tile(color = "black") +
  geom_text(aes(label = round(value, 2), color = text_color)) +
...
p_heat_v1
ggsave("../results/figures/main_heatmap_v1.jpeg", width = 10, height = 5, dpi = 100)
ggsave("../results/figures/main_heatmap_v1.pdf", width = 10, height = 5)
```
...
df_corr1 = as.data.frame(corr1) %>%
  ...
  pivot_longer(cols = -var1, names_to = "var2", values_to = "value")
df_fig1 = df_corr1 %>%
  left_join(df_p_v2, by = c("var1", "var2")) %>%
  mutate(text_color = ifelse(pvalue < 0.05, "1", "0"))
...
p_heat_v2
ggsave("../results/figures/main_heatmap_v2.jpeg", width = 10, height = 5, dpi = 100)
ggsave("../results/figures/main_heatmap_v2.pdf", width = 10, height = 5)
```

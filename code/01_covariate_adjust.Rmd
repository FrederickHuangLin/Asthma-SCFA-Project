...
3. Steiger’s z test was used to determine whether two Pearson correlation coefficients are the same or not between time points within the same group.
...
p_heat
ggsave("../results/figures/main_heatmap.jpeg", width = 12, height = 10, dpi = 100)
ggsave("../results/figures/main_heatmap.pdf", width = 12, height = 10)
```
